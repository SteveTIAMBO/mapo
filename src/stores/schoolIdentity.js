...
export const useSchoolIdentityStore = defineStore('schoolIdentity', () => {
  ...
  function isModuleActif(key) {
    // Les modules du socle sont toujours actifs (non désactivables)
    if (SOCLE_MODULES.includes(key)) return true
  ...
  return {
    ...
    nom, sigle, edition, logoUrl, anneeAcademique, modulesActifs,
