...
const DEMO_PROFILES = [
  ...
  { key: 'enseignant', label: 'Enseignant', description: 'Mes cours, mes étudiants, la saisie des notes', enabled: true, loginRole: 'enseignant',
  ...
  { key: 'etudiant', label: 'Étudiant', description: 'Mon parcours, mes notes, mon emploi du temps', enabled: true, loginRole: 'etudiant',
  ...
  { key: 'parent', label: 'Parent', description: 'Le suivi de mon étudiant : notes, paiements, emploi du temps', enabled: true, loginRole: 'parent',
