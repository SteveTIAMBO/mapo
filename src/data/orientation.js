...
export const COMPETENCES_6C = [
  ...
  {
    key: 'resilience',
    label: 'Résilience & adaptabilité',
    label_en: 'Resilience & adaptability',
    court: "Rebondir après un échec et s'adapter au changement.",
    question: "Je rebondis après une difficulté et je m'adapte au changement.",
    source: 'WEF Future of Jobs 2025 (résilience/flexibilité = 2ᵉ compétence clé) ; OECD Learning Compass 2030.',
    items: [
      { fr: "Après un échec, je me relève et je réessaie.", en: "After a failure, I pick myself up and try again." },
      { fr: "Je m'adapte facilement quand les choses changent.", en: "I adapt easily when things change." },
      { fr: "Une critique ne me décourage pas, j'en tire quelque chose.", en: "Criticism doesn't discourage me — I learn from it." },
      { fr: "Je garde mon calme face à l'imprévu.", en: "I stay calm when the unexpected happens." },
      { fr: "Je trouve un plan B quand le premier ne marche pas.", en: "I find a plan B when the first one doesn't work." },
    ],
  },
  {
    key: 'curiosite',
    label: 'Curiosité & apprendre à apprendre',
    label_en: 'Curiosity & learning to learn',
    court: "Avoir envie d'apprendre et savoir apprendre par soi-même.",
    question: "J'aime apprendre de nouvelles choses par moi-même.",
    source: 'WEF Future of Jobs 2025 (curiosité & apprentissage tout au long de la vie) ; OECD Learning Compass 2030 (apprendre à apprendre).',
    items: [
      { fr: "J'aime découvrir et comprendre comment les choses marchent.", en: "I love discovering and understanding how things work." },
      { fr: "Je pose des questions quand quelque chose m'intrigue.", en: "I ask questions when something intrigues me." },
      { fr: "J'apprends des choses par moi-même, sans qu'on me le demande.", en: "I learn things on my own, without being asked." },
      { fr: "Je sais organiser mon travail pour apprendre efficacement.", en: "I know how to organise my work to learn effectively." },
      { fr: "Une nouvelle matière me donne envie plutôt que peur.", en: "A new subject excites me rather than scares me." },
    ],
  },
  {
    key: 'motivation',
    label: 'Motivation & connaissance de soi',
    court: "Se fixer des buts, se connaître et rester motivé dans la durée.",
    label_en: 'Motivation & self-awareness',
    question: "Je me fixe des objectifs et je me connais bien.",
    source: 'WEF Future of Jobs 2025 (motivation & connaissance de soi = 5ᵉ) ; autorégulation (OECD).',
    items: [
      { fr: "Je me fixe des objectifs et je m'y tiens.", en: "I set goals and stick to them." },
      { fr: "Je sais ce qui me motive et ce qui me freine.", en: "I know what motivates me and what holds me back." },
      { fr: "Je continue même quand ce n'est pas amusant, si c'est important.", en: "I keep going even when it's not fun, if it matters." },
      { fr: "Je reconnais mes émotions et je sais les gérer.", en: "I recognise my emotions and can manage them." },
      { fr: "Je fais le point sur mes progrès régulièrement.", en: "I regularly take stock of my progress." },
    ],
  },
  {
    key: 'responsabilite',
    label: 'Responsabilité & citoyenneté',
    label_en: 'Responsibility & citizenship',
    court: "Agir de façon responsable et se soucier des autres et de son environnement.",
    question: "J'agis de façon responsable envers les autres et mon environnement.",
    source: 'OECD Learning Compass 2030 (compétence transformatrice « assumer ses responsabilités ») ; citoyenneté / environnement (WEF).',
    items: [
      { fr: "Je tiens mes engagements et je fais ce que je dis.", en: "I keep my commitments and do what I say." },
      { fr: "Je me soucie des autres et je cherche à aider.", en: "I care about others and try to help." },
      { fr: "Je fais attention à mon environnement (déchets, ressources).", en: "I care for my environment (waste, resources)." },
      { fr: "J'assume mes erreurs au lieu de chercher un coupable.", en: "I own my mistakes instead of blaming others." },
      { fr: "Je respecte les règles quand elles sont justes, et je le dis quand elles ne le sont pas.", en: "I respect fair rules, and speak up when they aren't." },
    ],
  },
]
